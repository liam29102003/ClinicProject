...
<div class="row mb-3">
        ...
        <form action="" wire:submit='save'>
            ...
            <div class="col-12 col-md-8 offset-md-2 p-5 border-rounded form-container d-flex flex-column justify-content-center align-items-center">
                ...
                <div class=" w-100 text-center m-auto mb-3">
        <a href="{{route('appointment#new')}}" style='color:"inherit"'>New Patient</a>
        <a href="{{route('appointment#old')}}" class="p-2 text-white ms-3 text-dark bg-dark" style='border-bottom:3px solid black'>Old Patient</a>
                </div>
                ...
                <input type="submit" value="Make Appointment" class="btn btn-dark mt-3">
